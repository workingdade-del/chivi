import { getFinanceAccounts, getFinanceMonthlyHistory } from "@/lib/finance";
import { FinanceAccountsScreen } from "@/components/admin/FinanceAccountsScreen";

export default async function AdminFinancePage() {
  const [accounts, monthly] = await Promise.all([getFinanceAccounts(), getFinanceMonthlyHistory()]);
  ...
  return <FinanceAccountsScreen accounts={accounts} soldeNet={soldeNet} totalDettes={totalDettes} monthly={monthly} />;
}
